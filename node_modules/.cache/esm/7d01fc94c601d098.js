let Prompts,Joi,CustomErrorHandler;_c60‍.x([["default",()=>_c60‍.o]]);_c60‍.w("../../../model",[["Prompts",["Prompts"],function(v){Prompts=v}]]);_c60‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_c60‍.w("../../../services/CustomErrorHandler",[["default",["CustomErrorHandler"],function(v){CustomErrorHandler=v}]]);
...
const prompt_controller = {
    ...
    async getprompt(req, res, next) {
        ...
        _c60‍.g.console.log(req.query.key);
        try {
